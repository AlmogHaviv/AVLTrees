import unittest
import avl_template_new  # Assuming your AVL tree implementation is in avl_template_new.py
...
class TestAVLTree(unittest.TestCase):
    ...
    def test_delete_and_balance(self):
        ...
        # Delete a node and check balancing
        avl_tree.delete(avl_tree.search(4))
        self.assertEqual(avl_tree.root.get_value(), "five")
        self.assertEqual(avl_tree.root.get_left().get_value(), "three")
        self.assertEqual(avl_tree.root.get_right().get_value(), "seven")
        self.assertEqual(avl_tree.root.get_right().get_left().get_value(), None)
        self.assertEqual(avl_tree.root.get_left().get_left().get_value(), "two")
